"""
  ...
  Last commit date      :   7th October
"""

# This import exists to check if a last loaded file exists in the directory
...
def main_game():
    """main method to be called in order to run the application"""
